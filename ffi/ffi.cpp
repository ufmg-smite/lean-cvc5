...
LEAN_EXPORT lean_obj_res term_getRealAlgebraicNumberValue(lean_obj_arg t)
{  
  CVC5_LEAN_API_TRY_CATCH_EXCEPT_BEGIN;
  return except_ok(lean_mk_string(term_unbox(t)->getRealAlgebraicNumberValue().c_str()));
  CVC5_LEAN_API_TRY_CATCH_EXCEPT_END;
}
